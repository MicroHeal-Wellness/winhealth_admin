...
import 'package:winhealth_admin/components/graphs/comparision_graph_builder.dart';
import 'package:winhealth_admin/components/graphs/single_graph_builder.dart';
...
class _ActivityStatsState extends State<ActivityStats>
  ...
  getInitData() async {
    ...
    stats =
        await ActivityService.getActivitiesStatByUserID(widget.patient.id!);
    setState(() {
      isLoading = false;
    });
  }
