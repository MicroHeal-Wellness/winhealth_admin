...
class FoodItemCard extends StatelessWidget {
  ...
  final bool showMenu;
  const FoodItemCard({super.key, required this.recommendedDietItem, this.showMenu = true});
            ...
            child: MenuAnchor(
              ...
              menuChildren: [
                ...
                MenuItemButton(
                  ...
                  onPressed: () {},
                  child: const Text('Add Cooking Instruction'),
                ),
                MenuItemButton(
                  style: const ButtonStyle(
                    backgroundColor: MaterialStatePropertyAll(Colors.white),
            ...
            children: [
              ...
              Wrap(
                children: [
                  ...
                  Text(
                    "${recommendedDietItem.foodItem!.saturatedFat} g",
                    style: const TextStyle(
                      fontWeight: FontWeight.w500,
                      fontSize: 18,
                    ),
